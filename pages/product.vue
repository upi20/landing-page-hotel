            ...
            <ul class="grid grid-cols-1 gap-6 lg:grid-cols-2">
              ...
              <li class="jos">
                ...
                >
                  <!-- Thumbnail -->
                  <img
                    src="@/assets/img/images/th-1/project-thumbnail-1.jpg"
              ...
              <li class="jos">
                ...
                >
                  <!-- Thumbnail -->
                  <img
                    src="@/assets/img/images/th-1/project-thumbnail-2.jpg"
                  ...
                  >
                    <div class="max-w-[520px] flex-1 text-colorButteryWhite">
                      ...
                      >
                      <p class="line-clamp-2">
                        Creating or refreshing a company's logo and developing a
              ...
              <li class="jos">
                ...
                >
                  <!-- Thumbnail -->
                  <img
                    src="@/assets/img/images/th-1/project-thumbnail-3.jpg"
              ...
              <li class="jos">
                ...
                >
                  <!-- Thumbnail -->
                  <img
                    src="@/assets/img/images/th-1/project-thumbnail-4.jpg"
                  ...
                  >
                    <div class="max-w-[520px] flex-1 text-colorButteryWhite">
                      ...
                      >
                      <p class="line-clamp-2">
                        Creating packaging solutions for products that not only
                        protect attract customers on store.
                      </p>
                    </div>
                    <a
                      class="relative hidden items-start justify-center overflow-hidden sm:inline-flex"
              ...
              <li class="jos">
                ...
                >
                  <!-- Thumbnail -->
                  <img
                    src="@/assets/img/images/th-1/project-thumbnail-5.jpg"
              ...
              <li class="jos">
                ...
                >
                  <!-- Thumbnail -->
                  <img
                    src="@/assets/img/images/th-1/project-thumbnail-6.jpg"
              ...
              <li class="jos">
                ...
                >
                  <!-- Thumbnail -->
                  <img
                    src="@/assets/img/images/th-1/project-thumbnail-7.jpg"
              ...
              <li class="jos">
                ...
                >
                  <!-- Thumbnail -->
                  <img
                    src="@/assets/img/images/th-1/project-thumbnail-8.jpg"
                  ...
                  >
                    <div class="max-w-[520px] flex-1 text-colorButteryWhite">
                      ...
                      <p class="line-clamp-2">
                        ...
                        visually appealing and responsive to different devices.
                      </p>
                    </div>
                    <a
                      class="relative hidden items-start justify-center overflow-hidden sm:inline-flex"
